...
unsigned int nTargetSpacing = 1 * 60; // 2 minutes
unsigned int nTargetSpacing_v2 = 2 * 60; // 3 minutes
...
const string strMessageMagic = "realx Signed Message:\n";
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);
            ...
            if(nBestHeight <= 10)
            {
            nSubsidy >>= nSubsidy /100000;  //no pos
            }

            else if(nBestHeight > 10)
            {
            nSubsidy = nSubsidy * 1 ;  //
            }         
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "realx", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "realxsjretykityu";
        CTransaction txNew;
        txNew.nTime = 1538539676;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1538539676;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1589456 : 1589456;
		...
		//block.GetHash() == 00000a258aca10238ab4b38d022178d53e7e6965840af63e716dd73c2e159e48
		//block.hashMerkleRoot == 4166246f69ce89da53f24c836f6abdfb91327c9e18051bfb7396088176ce0819
		//block.nTime = 1538539676 
		//block.nNonce = 1589456 

        assert(block.hashMerkleRoot == uint256("0x4166246f69ce89da53f24c836f6abdfb91327c9e18051bfb7396088176ce0819"));
        ...
        BOOST_FOREACH(const CInv& inv, vInv)
        {
            ...
            if (inv.type == MSG_BLOCK)
            {
                ...
                if (mi != mapBlockIndex.end())
                {
                    ...
                    {
                        // realxs: send latest proof-of-work block to allow the
